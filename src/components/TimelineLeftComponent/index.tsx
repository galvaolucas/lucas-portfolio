...
export function TimelineLeft({companyName, role, description, periodFrom, periodTo}:TimelineBoxProps) {
    return (
        <Flex w="100%" h="260px" direction="row"  alignItems="center" justifyContent="center" gap="50px">
          ...
          <Flex h="100%" mr="500px" direction="column" justifyContent="center" alignItems="center">
            <Box h="24%" w="3px" bgColor="yellow.400" display="flex" alignItems="center" justifyContent="center" />
              ...
              <Text fontSize="12px" fontStyle="italic">-</Text>
